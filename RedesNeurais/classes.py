...
class Valor:
    ...
    def __radd__(self, outro_valor): # outro_valor + self   # R.05
    ...
    def __rmul__(self, outro_valor): # outro_valor * self  # R.05
        return self * outro_valor
    
    def __pow__(self, expoente): # self ** expoente   # R.05
    ...
    def __truediv__(self, outro_valor): # self / outro_valor   # R.05
        return self * outro_valor ** (-1)
    
    def __neg__(self): # -self   # R.05
        return self * (-1)
    
    def __sub__(self, outro_valor): # self - outro_valor   # R.05
        return self + (-outro_valor)
    
    def __rsub__(self, outro_valor): # outro_valor - self   # R.05
